...
#include <mitmnns/impl/kdtree_search.hpp>
#include <mitmnns/impl/SU2_operation.hpp>

#include "utils.hpp"


// meet in the middle using kdtree for single qubit gate synthesis
...
int main() {
    ...
    QSY::kdtree<float> kt(v2._data, v2._bound);
    QSY::MITM<float, QSY::kdtree<float>, QSY::SU2<float>> mitm(v1._data, v1._bound, &kt);
