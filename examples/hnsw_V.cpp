...
int main() {
    ...
    std::string prefix = "data/hnsw_V" + std::to_string(D) +"_";
    QSY::hnsw<float, D> hnsw(v2._data, v2._bound, {.hnsw_graph_prefix = prefix});
    QSY::MITM<float, QSY::hnsw<float, D>, QSY::SU2<float>> mitm(v1._data, v1._bound, &hnsw);
